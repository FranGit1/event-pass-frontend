...
export type ICheckboxProps = Omit<
  IFieldComponentBaseProps<boolean>,
  "placeholder"
> & {
...
export const Checkbox = (props: ICheckboxProps) => {
  return (
    <div css={[tw`flex flex-col  gap-x-4`, props.containerCss]}>
      <FieldLabel
        isInErrorState={!!props.error}
        disabled={props.disabled}
        containerCss={[tw`text-primary`]}
      >
        {props.label}
      </FieldLabel>
      <input
        ...
        css={[
          ...
          tw`hover:(border-primary checked:bg-primary-100 )`,
